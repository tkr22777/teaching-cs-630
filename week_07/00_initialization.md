# Database Initialization - Week 7: SQL Subqueries

## Overview

This initialization script sets up the university enrollment database used throughout all Week 7 SQL Subqueries lessons.
...
The data includes various scenarios useful for demonstrating subqueries, including NULL values, aggregates, and comparisons across related tables.

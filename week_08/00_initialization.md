# Database Initialization - Week 8: SQL Functions and Set Operators

## Overview

This initialization script sets up the university enrollment database used throughout all Week 8 SQL Functions and Set Operators lessons.

## Database Schema

The database consists of four interconnected tables representing a university course enrollment system:

- **Students**: Student information (includes GPA)
- **Instructors**: Faculty information
- **Courses**: Course catalog
- **Enrollments**: Student course enrollments with grades (junction table)

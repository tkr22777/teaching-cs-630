...
- Returns NULL for unmatched right-table columns
- Essential for finding missing relationships
- Use COUNT(column) not COUNT(*) to handle NULLs correctly
- Perfect for complete rosters and reports
- Filter for NULLs to find unmatched records
...
-- Count with LEFT JOIN (NULL-safe)
